...
# from module.structure_module import StructureModuleTest
...
class StructureModule(nn.Module):
    ...
    def forward(
        ...
        # outputs = self.stm(evoformer_output_dict['single'], evoformer_output_dict['pair'], aatype, mask)
